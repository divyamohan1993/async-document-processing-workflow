...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-4 py-8 bg-grid">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 left-1/2 h-80 w-80 -translate-x-1/2 rounded-full bg-primary/10 blur-[100px]" />
        <div className="absolute -bottom-40 left-1/4 h-60 w-60 rounded-full bg-primary/5 blur-[80px]" />
      </div>
